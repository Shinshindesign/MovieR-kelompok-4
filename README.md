 ...
 <div class="film-card">
    <div class="film-info">
        ...
        <p>Pemeran: Dwayne Johsom (Dr. Smolder), Karen Gillian (Ruby), Kevin Hart (Moose), Awkwafina (Ming
            Fleetfoot)</p>
          <iframe src="https://www.youtube.com/embed/rBxcF-r9Ibs" frameborder="0" allowfullscreen></iframe>
...
<div class="film-card">
    <div class="film-info">
        <h2>Onward</h2>
        <img src="Pictures/IMG-20250328-WA0014.jpg" alt="Poster film Onward">
...
<div class="film-card">
    <div class="film-info">
        ...
        <img src="pictures/WhatsApp Image 2025-04-13 at 08.47.29_b63ca0a6.jpg" alt="Poster film Cek Toko Sebelah">
        <p>Genre: Komedi, Drama</p>
        <p>Tahun: 2022</p>
        <p>Rating: 4.7 ⭐⭐⭐⭐⭐</p>
        <button onclick="tampilkanInfo(this)">Pelajari lebih lanjut</button>
...
<div class="film-card">
    <div class="film-info">
        ...
        <img src="pictures/WhatsApp Image 2025-05-29 at 19.57.09_9ce83332.jpg" alt="Poster film Mr. Bean Holiday">
        <p>Genre: Komedi</p>
        <p>Tahun: 2007</p>
        <p>Rating: 4.2 ⭐⭐⭐⭐</p>
        <button onclick="tampilkanInfo(this)">Pelajari lebih lanjut</button>
